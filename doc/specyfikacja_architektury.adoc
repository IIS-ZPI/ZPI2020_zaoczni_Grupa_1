...
== Wprowadzenie
OpenNBP Analyzer to aplikacja mający na celu umożliwienie użytkownikom 
...
niewielkich aplikacji oraz zapewnia wbudowane łatwe narzędzia do wykonywania operacji 
...
podczas gdy osoba odpowiedzialan za przygotowanie architektury dysponuje wystarczającą 
